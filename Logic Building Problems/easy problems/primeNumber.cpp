...
int main(){
   ...
   // this (a, b)'s any one is less then sqrt(n) or both are equal to sqrt(n)
   ...
   //note: greater then 3, then every prime number has a pattern
   ...
   //6 * 5 - 1 = 29 (prime)
   // ..... 
   //so check greater then 3 as ((6 * i) - 1)%2==0 || ((6 * i) + 1)%2==0 => not prime
